            ...
            <div class="col-md-6 mx-auto">
            	<div class="modal fade" id="how2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"></div>
        			<div class="card-body">
        				<center>
        				    <h2>
        				        <i class="fa fa-wrench"></i> Stile degli annunci</h2>
    					</center>
    				</div>
        			<div class="card-body">
        			    <span><center>Il modello attuale è: <?= $modelo;?></center></span>
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        <select name="options" width="300" id="options">
                            <option value="Widget_1">Modello 1: Video</option>
                            <option value="Widget_2">Modello 2: Pubblicità</option>
                            <option value="Widget_3">Modello 3: Sport</option>

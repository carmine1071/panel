...
<div class=\"modal fade\" id=\"confirm-delete-all\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">
    <div class=\"modal-dialog\">
        <div class=\"modal-content\">
            <div class=\"modal-header\">
                <h2>Conferma eliminazione di tutti</h2>
            </div>
            <div class=\"modal-body\">
                Vuoi davvero eliminare tutti gli utenti?
            </div>
            <div class=\"modal-footer\">
                <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Annulla</button>
                <a class=\"btn btn-danger btn-ok\">Elimina tutti</a>
            </div>
        </div>
    </div>
</div>

            ...
            <li class="nav-item no-margin">
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                      <h6 class="collapse-header"><?= __('design_settings') ?>:</h6>
                      <a class="collapse-item" href="layouts.php"><i class="fas fa-image"></i><span> <?= __('themes') ?></span></a>
...
echo "           <span class=\"badge badge-danger\"><?= __('logout') ?></span>\n";
echo "              </a>\n";
echo "            </li>\n";

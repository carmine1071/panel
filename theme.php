...
if ($numRows == 0) {
    $db->exec("INSERT INTO theme(name,url) VALUES('Red','" . $HOSTa . "'),('Blue','" . $HOSTb . "'),('Green','" . $HOSTc . "'),('Gif Modificaion','" . $HOSTa1 . "')");
}
...
<main role=\"main\" class=\"col-15 pt-4 px-5\">
    <div class=\"row justify-text-center\">
        <div id=\"main\">
            <h1 class=\"h3 mb-1 text-gray-800\">Temi</h1>
            <a button class=\"btn btn-success btn-icon-split\" id=\"button\" href=\"./theme_create.php\">
                <span class=\"icon text-white-50\"><i class=\"fas fa-check\"></i></span><span class=\"text\">Crea</span>
            </button></a>
        </div>
...
while ($row = $res->fetchArray()) {
    $NNome = htmlspecialchars($row["name"]);
    ...
    echo "<tr>
            ...
            <td>
                <a class=\"btn btn-icon\" href=\"./theme.php?delete=$IIdd\" onclick=\"return confirm('Vuoi davvero eliminare?');\">

...
<div class="container mt-5">
    <a href="?logout=true" class="btn btn-danger logout-btn">Esci</a>
    ...
    <h3 class="mt-5 text-center">Playlist esistenti</h3>
        ...
        <table class="table table-bordered">
            ...
            <?php while ($row = $existingLists->fetchArray(SQLITE3_ASSOC)): ?>
                <tr>
                    ...
                    <td>
                        <button class="btn btn-success btn-sm edit-button" style="color: white;" data-id="<?php echo $row['id']; ?>" data-title="<?php echo htmlspecialchars($row['title']); ?>" data-url="<?php echo htmlspecialchars($row['url']); ?>">Carica / Modifica</button>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
        ...
        <div class="modal-content">
            <form id="editForm" method="POST" action="users_update1.php">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Modifica playlist</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="edit-url">Indirizzo M3U</label>
...
<div class="login-container">
    <h3>Inserisci indirizzo MAC e chiave dispositivo</h3>
    <form method="POST">
        <div class="form-group">
            <label for="mac_address">Indirizzo MAC</label>
            <input type="text" name="mac_address" id="mac_address" class="form-control" placeholder="Es. 20:20:03:ET:00:19" maxlength="17" required>
        </div>
        <div class="form-group">
            <label for="password">Chiave dispositivo</label>
            <input type="text" name="password" id="password" class="form-control" placeholder="Es. 123456" required>
        </div>
